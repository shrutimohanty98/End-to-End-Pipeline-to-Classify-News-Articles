...
4. Place the GLoVE embedding text files in a folder called 'glove' in the same directory where the notebook is located.
5. Open the notebook and just sequentially run all the sections.
6. All question answers can be browsed through from the left toolbar of the Colab notebook or Jupyter.